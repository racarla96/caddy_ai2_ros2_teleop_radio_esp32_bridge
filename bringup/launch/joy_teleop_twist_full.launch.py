...
def generate_launch_description():
    ...
    twist_config_filepath = launch.substitutions.LaunchConfiguration('twist_config_filepath')
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('twist_config_filepath', default_value=[
            launch.substitutions.TextSubstitution(text=os.path.join(
                get_package_share_directory('caddy_ai2_ros2_teleop_radio_esp32_bridge'), 'config', 'twist_to_topics.yaml'))]),
        ...
        # Nodo convertidor de Twist a topics individuales
        launch_ros.actions.Node(
            package='caddy_ai2_ros2_teleop_radio_esp32_bridge',
            executable='twist_to_topics_node',
            name='twist_to_topics_node',
            parameters=[twist_config_filepath],
            remappings=[
